    ...
    this.languageBlock = create('div', 'header__language-block', [
      create('select', 'header__language-block__list',
        `<option class="header__language-block__list__item" value="EN">EN</option>
         ...
         <option class="header__language-block__list__item" value="DE">DE</option>`, this.languageBlock, ['id', 'select__language'], ['tabindex', '4']),
    ], this.header);
  }

  addButtonOpenConfirmForm() {
    this.buttonConfirmForm = create('button', 'button-open-modal header__button-log', 'Log in', this.header, ['id', 'button-open-confirm-form'], ['tabindex', '1']);
  }
}
