...
export default class DescriptionBlock {
  ...
  initDescription() {
    this.description = create('div', 'main__other-section__sub-content-block__description-content',
      `<div class="olo">
        <div class="
    important_facility  " data-name-en="Free WiFi Internet Access Included">
        ...
        <div class="
    important_facility  " data-name-en="Parking (fee required)">
          <svg class="svg__facilities" height="20" width="20" viewBox="0 0 128 128" role="presentation" aria-hidden="true"
            focusable="false">
    ...
    important_facility  " data-name-en="Non Smoking Rooms">
        ...
        <div class="
    important_facility  " data-name-en="Restaurant">
          <svg class="svg__facilities" height="20" width="20" viewBox="0 0 128 128" role="presentation" aria-hidden="true"
            focusable="false">
            <path
        ...
        <div class="
    important_facility  " data-name-en="Rooms&#47;Facilities for Disabled">
          <svg class="svg__facilities" height="20" width="20" viewBox="0 0 128 128" role="presentation" aria-hidden="true"
            focusable="false">
